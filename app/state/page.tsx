    ...
    return (
        <div className="text-center">
            ...
            <div className="section1-box">
                ...
                <p className="section1-caption ibm-plex-sans-thai-extralight">เนื้อหางาน week3 จะเป็นการสอนเพิ่มเติมเกี่ยวกับ css สอนและเริ่มต้นใช้ framework ต่างๆ"</p>
            ...
            <div className="bg-red-300 text-black"><br></br>
                ...
                <div className="flex justify-center">
                    ...
                    <div className="flex justify-center p-4">
                        {isLightOn ? <img src="https://www.w3schools.com/js/pic_bulbon.gif"></img> : <img src="https://www.w3schools.com/js/pic_bulboff.gif"></img>}
                    </div>
            </div>
            <Footer/>
        </div>
